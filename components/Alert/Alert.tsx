...
export const Alert = () => {
    return (
        <div className='sticky flex justify-center px-8 py-2 mx-auto font-medium text-center bg-stratos-900/20 backdrop-blur-sm sm:px-16 md:px-24 text-sylver-100'>
