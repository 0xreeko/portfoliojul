...
export const AboutMe = () => {
    return (
        <div className='flex flex-col max-w-xl py-12 gap-y-6'>
            <p>GM anon! I&apos;m 0xreeko, a 23 year old Fullstack Web3 Developer and I enjoy solving problems and materialising visions into tangible products. Born in Madrid, and have been living in London for the past 12 years.</p>
