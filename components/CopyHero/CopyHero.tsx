...
export const CopyHero = () => {
    ...
    return (
        <section id='hero'>
            {/* @ts-ignore */}
            <div className="flex flex-col items-center justify-center gap-6 py-12 lg:min-h-[60vh] text-center md:text-left">
                ...
                <div className="flex flex-col justify-center w-full">
                    <span className='font-bold text-center text-m-h5 sm:text-d-h5'>GM anon👾, I&apos;m</span>
