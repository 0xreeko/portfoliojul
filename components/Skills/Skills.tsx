...
import { ethers, githubActions, gql, greensock, hardhat, jwt, mongodb, nextjs, node, photoshop, prisma, python, solidity, tailwind, trpc, typescript, vitest } from '../Icons';

export const Skills = () => {
    return (
        <section id='skills' className='py-16'>
            <div className="flex items-end gap-4">
                <span className='font-mono text-m-sub1 md:text-d-sub1 text-amethyst-400'>02.</span>
