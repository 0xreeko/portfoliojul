        ...
        <div className="w-full px-8 mt-12 sm:px-16 md:px-32 lg:px-64">
          ...
          <div className=" fixed -right-[5%] top-[61%] w-72 h-72 blur-[3px] opacity-40 rotate-[66deg]">
            ...
            {posts.length > 0 ? posts.map((item: ReekoPost) => (
              <li key={item.id} className="flex w-full p-4 duration-300 border rounded-lg border-sylver-100 border-opacity-5 backdrop-blur-sm bg-amethyst-400/5 hover:bg-amethyst-400/10 hover:border-opacity-10">
